...
const ArticleDetail: React.FC = () => {
  ...
  const displayContent = (isZh && article.contentZh) ? article.contentZh : article.content;
  ...
  const shareLinks = {
    ...
    twitter: `https://twitter.com/intent/tweet?url=${encodeURIComponent(articleUrl)}&text=${encodeURIComponent(displayTitle)}`,
