    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-slate-50 py-24 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold text-blue-950 mb-6 serif-font text-center">{t('about.header.title')}</h1>
          <div className="w-24 h-1 bg-[#4A90E2] mx-auto mb-12"></div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-2xl font-bold text-blue-900 mb-6 uppercase tracking-widest text-sm">{t('about.header.subtitle_1')}</h2>
              <p className="text-slate-700 text-lg leading-relaxed mb-8">
                {t('about.header.description_1')}
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-blue-900 mb-6 uppercase tracking-widest text-sm">{t('about.header.subtitle_2')}</h2>
              <p className="text-slate-700 text-lg leading-relaxed">
                {t('about.header.description_2')}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-blue-950 mb-16 serif-font uppercase tracking-widest">{t('about.approach.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#4A90E2] font-medium text-lg max-w-[200px]">{t('about.approach.item_1')}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#4A90E2] font-medium text-lg max-w-[200px]">{t('about.approach.item_2')}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#4A90E2] font-medium text-lg max-w-[200px]">{t('about.approach.item_3')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-950 mb-4 serif-font">{t('about.leadership.title')}</h2>
            <p className="text-slate-600">{t('about.leadership.subtitle')}</p>
          </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-10 bg-slate-900/90 backdrop-blur-md animate-in fade-in duration-300">
          <div className="relative w-full max-w-5xl bg-white rounded-lg shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in zoom-in duration-300">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-4 space-y-8">
                  ...
                  {selectedMember.qualifications && (
                    <div className="space-y-4">
                      <h4 className="flex items-center text-blue-900 font-bold uppercase tracking-wider text-xs">
                        <GraduationCap className="w-4 h-4 mr-2" /> {t('about.modal.qualifications')}
                      </h4>
                  ...
                  {selectedMember.memberships && (
                    <div className="space-y-4">
                      <h4 className="flex items-center text-blue-900 font-bold uppercase tracking-wider text-xs">
                        <Users className="w-4 h-4 mr-2" /> {t('about.modal.memberships')}
                      </h4>
                      <ul className="space-y-2 text-sm text-slate-600 border-l border-slate-200 pl-4">
                ...
                <div className="lg:col-span-8 space-y-10">
                  <div className="prose prose-blue max-w-none">
                    <h3 className="text-blue-950 text-xl font-bold serif-font mb-4">{t('about.modal.biography')}</h3>
                  ...
                  {selectedMember.publications && (
                    <div className="bg-slate-50 p-6 md:p-8 rounded-xl border border-slate-100">
                      <h3 className="flex items-center text-blue-950 text-xl font-bold serif-font mb-6">
                        <BookOpen className="w-5 h-5 mr-3 text-[#4A90E2]" /> {t('about.modal.publications')}
                      </h3>
            ...
            <div className="sticky bottom-0 bg-slate-50 border-t border-slate-100 px-6 py-6 md:px-10 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-slate-500 text-center sm:text-left">{t('about.modal.interested')} {selectedMember.name.split(' ')[0]}?</p>
              <a
                href={WHATSAPP_LINK}
                target="_blank"
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 serif-font uppercase tracking-tight">{t('about.cta.title')}</h2>
